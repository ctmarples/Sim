...
class Toolbar:
    ...
    def _rebuild_static(self) -> None:
        ...
        self._menu_buttons = [
            ...
            self._make_btn("file_reset", "Reset", 8, TOOLBAR_HEIGHT + 290, 110, 24, "menu"),
            self._make_btn("day_slower", "Shorter day", 8, TOOLBAR_HEIGHT + 316, 110, 24, "menu"),
            self._make_btn("day_faster", "Longer day", 8, TOOLBAR_HEIGHT + 342, 110, 24, "menu"),
            self._make_btn("file_time_demo", "Time demo…", 8, TOOLBAR_HEIGHT + 368, 110, 24, "menu"),
            self._make_btn("file_quit", "Quit", 8, TOOLBAR_HEIGHT + 394, 110, 24, "menu"),
        ]
