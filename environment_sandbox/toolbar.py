...
class Toolbar:
    ...
    def _rebuild_static(self) -> None:
        ...
        self._menu_buttons = [
            ...
            self._make_btn("file_subtile_test", "Habitat test", 8, TOOLBAR_HEIGHT + 160, 110, 24, "menu"),
            self._make_btn("file_reset", "Reset", 8, TOOLBAR_HEIGHT + 186, 110, 24, "menu"),
            self._make_btn("day_slower", "Shorter day", 8, TOOLBAR_HEIGHT + 212, 110, 24, "menu"),
            self._make_btn("day_faster", "Longer day", 8, TOOLBAR_HEIGHT + 238, 110, 24, "menu"),
            self._make_btn("file_time_demo", "Time demo…", 8, TOOLBAR_HEIGHT + 264, 110, 24, "menu"),
            self._make_btn("file_quit", "Quit", 8, TOOLBAR_HEIGHT + 290, 110, 24, "menu"),
        ]
    ...
    def contains(self, pos: tuple[int, int]) -> bool:
        ...
        if self.file_menu_open:
            menu_rect = pygame.Rect(
                6, TOOLBAR_HEIGHT - 2, 114, len(self._menu_buttons) * 26 + 10
            )
