...
WILD_SPECIES: tuple[WildSpeciesDef, ...] = (
    ...
    _wild_crop("potato", "Potato", ("SOIL", "FOREST_FLOOR"), ((.15,.30,.70,.90),(.25,.40,.70,.90),(.40,.55,.85,1),(.15,.30,.60,.80)), texture_niche=NicheRange(.10,.30,.60,.80)),
    _wild_crop("pumpkin", "Pumpkin", ("MEADOW", "GRASS"), ((.20,.40,.80,.95),(.20,.35,.65,.85),(.30,.50,.85,1),(.10,.25,.55,.75)), texture_niche=NicheRange(.05,.20,.55,.75)),
    _wild_crop("kale", "Kale", ("SOIL", "FOREST_FLOOR"), ((.05,.20,.55,.75),(.25,.40,.75,.90),(.35,.50,.85,1),(.10,.25,.55,.75)), texture_niche=NicheRange(.10,.30,.60,.80)),
    _wild_crop("leek", "Leek", ("SOIL", "FOREST_FLOOR"), ((.10,.25,.60,.80),(.25,.40,.70,.90),(.30,.45,.80,.95),(.10,.30,.55,.75)), texture_niche=NicheRange(.00,.20,.50,.70)),
    _wild_crop("thyme", "Thyme", ("MEADOW", "GRASS"), ((.25,.40,.75,.90),(.10,.25,.55,.75),(.15,.30,.60,.80),(.10,.25,.50,.70)), texture_niche=NicheRange(.00,.15,.45,.65)),
    _wild_crop("rosemary", "Rosemary", ("MEADOW", "SOIL"), ((.25,.45,.80,.95),(.05,.20,.50,.70),(.10,.25,.55,.75),(.05,.20,.45,.65)), texture_niche=NicheRange(.00,.10,.40,.60)),
...
_ACTIVITY_PROFILES: dict[str, tuple[float, ...]] = {
    # Sp1 Sp2 Su1 Su2 Au1 Au2 Wi1 Wi2
    "peas": (.60, 1.00, .85, .45, .15, .05, .00, .05),
    "nettle": (.80, 1.00, .85, .60, .35, .15, .05, .15),
    "rye": (.55, .85, 1.00, .80, .40, .30, .20, .30),
    "barley": (.35, .75, 1.00, .85, .25, .05, .00, .05),
    "garlic": (.75, .95, 1.00, .75, .40, .35, .30, .40),
    "beans": (.10, .40, .80, 1.00, .65, .20, .00, .00),
    "blackberry": (.00, .00, .15, 1.00, .75, .15, .00, .00),
    "cabbage": (.25, .45, .65, .85, 1.00, .95, .50, .30),
    "carrot": (.15, .40, .75, 1.00, .90, .55, .15, .10),
    "elderberry": (.00, .00, .05, .45, 1.00, .55, .05, .00),
    "hazel": (.00, .00, .05, .20, .75, 1.00, .45, .20),
    "mint": (.20, .85, 1.00, .90, .45, .15, .05, .10),
    "mushroom": (.05, .10, .10, .25, .75, 1.00, .20, .05),
    "onion": (.35, .70, 1.00, .90, .55, .25, .10, .15),
    "sage": (.20, .55, .90, 1.00, .75, .35, .10, .10),
    "sloe": (.00, .00, .00, .05, .25, 1.00, .80, .40),
    "turnip": (.20, .45, .70, .90, 1.00, .85, .30, .20),
    "wheat": (.25, .65, 1.00, .95, .35, .10, .00, .05),
    "pumpkin": (.00, .00, .10, .55, 1.00, .85, .20, .05),
    "potato": (.05, .20, .85, 1.00, 1.00, .90, .70, .60),
    "thyme": (.20, .45, .75, 1.00, .90, .75, .45, .35),
    "leek": (.15, .25, .40, .60, .80, 1.00, .95, .75),
    "kale": (.20, .15, .15, .25, .50, .80, .95, 1.00),
    "rosemary": (.40, .50, .65, .75, .75, .70, .65, .60),
    # Unchanged extras (not in redesign sheet).
