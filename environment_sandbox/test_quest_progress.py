...
class QuestProgressTests(unittest.TestCase):
    ...
    def test_forage_counts_new_plants_and_yields(self):
        ...
        note_forage_collect(self.game,self.game.player.inventory,'blackberries',6)
        note_forage_collect(self.game,NS(),'blackberries',20)
        ...
        note_forage_collect(self.game,self.game.player.inventory,'blackberries',FORAGE_FOOD_GOAL)
