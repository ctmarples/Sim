...
CROPS: tuple[CropDef, ...] = (
    ...
    CropDef(
        ...
        label="Potato",
        produce_key="potato",
        seed_key="potato_seeds",
        short="pot",
        stem_colour=(90, 140, 70),
        flower_colour=(230, 220, 180),
        plant_season=Season.SPRING,
        harvest_seasons=(Season.AUTUMN,),
        growth_days=56,
        wild_seed_chance=WILD_SEED_CHANCE,
    ...
    CropDef(
        ...
        label="Pumpkin",
        produce_key="pumpkin",
        seed_key="pumpkin_seeds",
        short="pmp",
        stem_colour=(70, 130, 55),
        flower_colour=(230, 150, 40),
        plant_season=Season.SPRING,
        harvest_seasons=(Season.AUTUMN,),
        growth_days=72,
        wild_seed_chance=WILD_SEED_CHANCE,
        ...
        icon_base="crop_vine",
        dense_icon_base="vine_plant_dense",
    ),
    CropDef(
        key="kale",
        label="Kale",
        ...
        seed_key="kale_seeds",
        short="kal",
        stem_colour=(55, 120, 65),
        flower_colour=None,
        plant_season=Season.SUMMER,
        harvest_seasons=(Season.WINTER,),
        growth_days=56,
        wild_seed_chance=WILD_SEED_CHANCE,
        farm_seed_amounts=FARM_SEED_AMOUNTS,
        year_phases=_phases(
    ...
    CropDef(
        ...
        seed_key="leek_seeds",
        short="lek",
        stem_colour=(85, 150, 75),
        flower_colour=(230, 230, 200),
        plant_season=Season.SUMMER,
        harvest_seasons=(Season.AUTUMN, Season.WINTER),
        growth_days=72,
        wild_seed_chance=WILD_SEED_CHANCE,
        farm_seed_amounts=FARM_SEED_AMOUNTS,
        year_phases=_phases(
    ...
    CropDef(
        ...
        label="Thyme",
        produce_key="thyme",
        seed_key="thyme_seeds",
        short="thy",
        stem_colour=(70, 125, 70),
        flower_colour=(180, 140, 200),
        plant_season=Season.SPRING,
        harvest_seasons=(Season.SUMMER,),
        growth_days=32,
        wild_seed_chance=WILD_SEED_CHANCE,
    ...
    CropDef(
        key="rosemary",
        label="Rosemary",
        produce_key="rosemary",
        seed_key="rosemary_seeds",
        short="ros",
        stem_colour=(60, 110, 75),
        flower_colour=(120, 150, 210),
        plant_season=Season.SPRING,
